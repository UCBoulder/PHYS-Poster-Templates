...
% 34.82" x 46.43" landscape poster using Gemini beamer theme
%
...
\usepackage[orientation=landscape, size=custom, width=117.93, height=88.44, scale=1.0]{beamerposter}
% Width=46.43in=117.93cm, Height=34.82in=88.44cm (fits 36" roll printers without scaling)
